...
@Component({
  selector: 'app-gayway-userid',
  templateUrl: './gayway-userid.component.html',
  styleUrls: ['./gayway-userid.component.scss']
})
export class GaywayUseridComponent implements OnInit {
    storeData:any=[];
    storeCatData:any=[];
    catFData:any =[];
    csvData:any=[];
