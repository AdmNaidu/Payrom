...
@Component({
  selector: 'app-ac-payrow',
  templateUrl: './ac-payrow.component.html',
  styleUrls: ['./ac-payrow.component.scss']
})
export class AcPayrowComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.payrowAccountForm = this.fb.group({
  ...
  next() {
    ...
    if (this.step == 1) {
      // if (this.payrowAccountForm.controls.name.valid, this.payrowAccountForm.controls.password.valid,
      //   this.payrowAccountForm.controls.email.valid, this.payrowAccountForm.controls.cnfPassword.valid) {
  ...
  get f() {
    return this.payrowAccountForm.controls;
  }
  onSubmit() {
    console.log('payrowAccountForm Details', this.payrowAccountForm.value);
  }
